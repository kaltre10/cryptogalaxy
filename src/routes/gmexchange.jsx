...
const Gmexchange = () => {
    ...
    const { net,switchEthereumChain, Toast, sendTransaction, connectOrRegister, user, loading, stateLoading } = useContext(DataContext)
